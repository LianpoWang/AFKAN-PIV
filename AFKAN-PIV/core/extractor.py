...
import ssl
ssl._create_default_https_context = ssl._create_unverified_context  # 放在导入torchvision之前
import torchvision.transforms.functional as TF
from core.utils.layer import BasicBlock, conv1x1, conv3x3
    ...
    def _init_weights(self, args):
        ...
        if self.init_weight:
            ...
            if args.pretrain == 'resnet18':
                ...
                pretrained_dict = resnet34(weights=ResNet34_Weights.DEFAULT).state_dict()
